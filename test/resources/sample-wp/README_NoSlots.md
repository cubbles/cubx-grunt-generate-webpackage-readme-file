...
### Use of components
The html file should contain the desire component using its tag, e.g. the `<my-elementary-2>`, as follows:
```html
<my-elementary-2 cubx-webpackage-id="my-webpackage@0.1.0-SNAPSHOT"></my-elementary-2>
```
